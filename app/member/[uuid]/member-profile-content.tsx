...
// Tipo serializado para passar de Server para Client Component
interface SerializedMember extends Omit<Member, "joinedAt"> {
  joinedAt: string
}
...
export function MemberProfileContent({ member }: MemberProfileContentProps) {
                  ...
                  <motion.div variants={fadeInUp} className="flex-1 md:mb-4">
                    ...
                    <div className="flex flex-wrap gap-4 text-sm text-gray-600 dark:text-gray-400">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span>
                          Desde {new Date(member.joinedAt).toLocaleDateString("pt-BR", { month: "long", year: "numeric" })}
                        </span>
                      </div>
                    </div>
                  </motion.div>
                      ...
                      {member.social.instagram && (
                        <Button variant="outline" size="icon" asChild>
                          <a href={member.social.instagram} target="_blank" rel="noopener noreferrer">
                            ...
                            <span className="sr-only">Instagram de {member.name}</span>
                          </a>
                        </Button>
                      )}
