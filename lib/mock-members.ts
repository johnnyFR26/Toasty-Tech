...
export const mockMembers: Member[] = [
  {
    ...
    bio: "Fundador da Toasty Tech, apaixonado por criar soluções inovadoras que transformam negócios. Especialista em desenvolvimento web e mobile com foco em experiência do usuário.",
    projects: ["1", "2", "4"],
